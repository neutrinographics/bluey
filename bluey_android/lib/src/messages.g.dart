...
class BlueyHostApi {
  ...
  Future<int> getMaximumWriteLength(String deviceId, bool withResponse) async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.bluey_android.BlueyHostApi.getMaximumWriteLength$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<void> resetServerSessions() async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.bluey_android.BlueyHostApi.resetServerSessions$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
