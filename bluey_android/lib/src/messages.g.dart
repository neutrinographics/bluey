...
class BlueyConfigDto {
  ...
  static BlueyConfigDto decode(Object result) {
    ...
    return BlueyConfigDto(
      ...
      requestMtuTimeoutMs: result[6] as int?,
      readRssiTimeoutMs: result[7] as int?,
    );
  }
...
class BlueyHostApi {
  ...
  Future<void> resetServerSessions() async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.bluey_android.BlueyHostApi.resetServerSessions$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
