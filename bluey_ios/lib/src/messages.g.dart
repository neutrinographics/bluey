...
class NotificationEventDto {
  ...
  static NotificationEventDto decode(Object result) {
    ...
    return NotificationEventDto(
      ...
      characteristicHandle: result[3] as int?,
    );
  }
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(deviceId, other.deviceId) && _deepEquals(characteristicUuid, other.characteristicUuid) && _deepEquals(value, other.value) && _deepEquals(characteristicHandle, other.characteristicHandle);
  }
...
class BlueyHostApi {
  ...
  Future<void> resetServerSessions() async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.bluey_ios.BlueyHostApi.resetServerSessions$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
