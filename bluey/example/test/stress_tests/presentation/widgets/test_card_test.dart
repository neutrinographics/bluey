...
void main() {
  ...
  testWidgets('Idle card shows test name and enabled Run/Stop buttons', (
    tester,
  ) async {
  ...
  testWidgets('Run button is disabled when another card is running', (
    tester,
  ) async {
    var ran = false;
    await tester.pumpWidget(
  ...
  testWidgets(
    'Results panel renders attempted/succeeded/failed when result present',
    (tester) async {
  ...
  testWidgets(
    'Results panel shows Connection lost banner when connectionLost is true',
    (tester) async {
      final result = StressTestResult.initial()
          .recordSuccess(latency: const Duration(milliseconds: 10))
          .markConnectionLost()
  ...
  testWidgets(
    'Results panel does NOT show Connection lost banner when flag is false',
    (tester) async {
      final result = StressTestResult.initial()
          .recordSuccess(latency: const Duration(milliseconds: 10))
